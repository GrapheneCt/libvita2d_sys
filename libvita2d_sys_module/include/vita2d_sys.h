...
#define VITA2D_SYS_VERSION 0135

//#define VITA2D_SYS_SCE_PRX

#if _SCE_TARGET_OS_PSP2
#ifdef VITA2D_SYS_SCE_PRX
 ...
 */
#define vita2d_check_version(vita2d_version) (vita2d_version == VITA2D_SYS_VERSION ? 0 : -1);
 ...
 * @param[in] io_type - one of ::vita2d_io_type
 * @param[in] useMainMemory - set to 1 to use main user memory instead of phycont memory
